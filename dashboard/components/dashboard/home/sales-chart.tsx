...
export function SalesChart({
  ...
  return (
    <section className="rounded-2xl border border-separator bg-surface p-5 shadow-sm lg:col-span-2">
          ...
          return (
            ...
            >
              <div className="relative flex flex-1 items-end">
                <div
                  className="w-full rounded-t-lg bg-accent/75 transition hover:bg-accent"
                  style={{ height: `${height}%` }}
              ...
              <span className="mt-2 text-center text-[10px] text-muted sm:text-xs">
                {point.label}
              </span>
            </div>
          );
