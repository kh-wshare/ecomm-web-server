...
import { Button, Input, Select, TextArea } from "@/components/ui/hero-controls";
...
export function SocialPostComposer() {
  ...
  const canCreate = can("social_post.create");
  const canPublish = can("social_post.publish");
  const canAddHotspots = can("social_post.update");
  ...
  const saveMutation = useMutation({
    ...
    onSuccess: async (post, mode) => {
      ...
      router.push(`/dashboard/social-posts/${post.id}`);
    },
      ...
      <div className="grid gap-6 xl:grid-cols-[minmax(0,1.15fr)_minmax(340px,0.85fr)]">
        <div className="space-y-6">
          ...
          >
            <div className="flex flex-col gap-2 sm:flex-row">
              ...
              />
              <Button
                className="h-11 rounded-xl border border-separator px-4 text-sm font-semibold disabled:opacity-50"
                disabled={!mediaInput.trim() || mediaUrls.length >= 10}
                type="button"
                onClick={() => {
        ...
        <aside className="space-y-4 xl:sticky xl:top-24 xl:self-start">
          ...
          <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-1">
            <Button
              className="h-11 rounded-xl border border-separator bg-surface px-4 text-sm font-semibold disabled:opacity-50"
            ...
            {canPublish && (
              <Button
                className="h-11 rounded-xl bg-accent px-4 text-sm font-semibold text-accent-foreground disabled:opacity-50"
                disabled={saveMutation.isPending}
                type="button"
        ...
        <div className="grid gap-3 sm:grid-cols-2">
          ...
          <label className="sm:col-span-2">
            ...
            <div className="flex flex-col gap-2 sm:flex-row">
              ...
              />
              <Button
                className="h-11 rounded-xl border border-separator px-4 text-sm font-semibold"
                type="button"
                onClick={add}
              >
                Add hotspot
