      ...
      <div className="grid gap-6 xl:grid-cols-[minmax(0,1.15fr)_minmax(320px,0.85fr)]">
                ...
                {post.hotspots.map((hotspot) => (
                  ...
                  >
                    ...
                    <Link
                      ...
                      href={`/dashboard/products/${hotspot.productId}`}
                    >
                      View product →
                    </Link>
                  </div>
        ...
        <aside className="space-y-5 xl:sticky xl:top-24 xl:self-start">
          <Panel title="Destinations">
            ...
            {canPublish && (
              <Button
                className="mt-4 h-11 w-full rounded-xl bg-accent px-4 text-sm font-semibold text-accent-foreground disabled:opacity-50"
                disabled={!platforms.length || publishMutation.isPending}
                type="button"
